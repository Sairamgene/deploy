...
For new deployment process for a new developy on a new machine, refer to https://www.robinwieruch.de/firebase-deploy-react-js

    1. run `npm run build` command
    2. run `firebase init`
    3. select `Hosting: Configure and deploy Firebase Hosting sites`
    4. select `Use an exisiting project`
    5. select default firebase project for this directory: `Deploy-Trial`
